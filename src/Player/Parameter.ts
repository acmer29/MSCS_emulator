import { INITIAL_INTERVIEW_PROBABILITY, INITIAL_STUDY_VALUE, MAX_INTERVIEW_PROBABILITY, MAX_CODING, MAX_HEALTH, MAX_STUDY, MAX_WORKING, INITIAL_HEALTH_VALUE, INITIAL_CODING_VALUE } from "../Constant/PlayerConstants";
