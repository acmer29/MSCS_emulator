...
export const INITIAL_STUDY_VALUE: number = 40;
export const INITIAL_STUDY_VALUE_HIGH: number = 50;
export const INITIAL_STUDY_VALUE_LOW: number = 30;

export const INITIAL_CODING_VALUE: number = 10;
export const INITIAL_CODING_VALUE_HIGH: number = 30;
export const INITIAL_CODING_VALUE_LOW: number = 1;
